Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      post "/auth/complete-company-switch", to: "auth#complete_company_switch"
      post "/auth/browser-session", to: "auth#create_browser_session"
      get "/auth/browser-session", to: "auth#restore_browser_session"
      delete "/auth/browser-session", to: "auth#destroy_browser_session"
      ...
      namespace :client do
        ...
        get "/loans/:id", to: "portal#show_loan"
